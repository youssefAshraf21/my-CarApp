  ...
  return (
    <div className="group bg-[#1e293b] rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl hover:shadow-orange-500/10 transition-all duration-500 hover:-translate-y-2">
      <div className="relative overflow-hidden h-52">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-t from-[#1e293b] via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
        <button
      ...
      <div className="p-5">
        ...
        <p className="text-gray-400 text-sm leading-relaxed line-clamp-2 min-h-[2.5rem]">{car.description}</p>
