    ...
    <footer className="footer">
      <div className="footer-container">
        <div className="footer-brand">
          <h3>
            <span style={{ color: '#f97316' }}>Auto</span>Drive
          </h3>
          <p>
            Premium luxury car marketplace. Find your perfect drive with our curated
        ...
        <div>
          ...
          <ul>
            <li>
              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="#f97316" viewBox="0 0 16 16" style={{ marginRight: 8, verticalAlign: -2 }}><path d="M.05 3.555A2 2 0 0 1 2 2h12a2 2 0 0 1 1.95 1.555L8 8.414.05 3.555zM0 4.697v7.104l5.803-3.558L0 4.697zM6.761 8.83l-6.57 4.027A2 2 0 0 0 2 14h12a2 2 0 0 0 1.808-1.144l-6.57-4.027L8 9.586l-1.239-.757zm3.436-.586L16 11.801V4.697l-5.803 3.546z"/></svg>
              <a href="mailto:info@autodrive.com">info@autodrive.com</a>
            </li>
            <li>
              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="#f97316" viewBox="0 0 16 16" style={{ marginRight: 8, verticalAlign: -2 }}><path d="M3.654 1.328a.678.678 0 0 0-1.015-.063L1.605 2.3c-.483.484-.661 1.169-.45 1.77a17.568 17.568 0 0 0 4.168 6.608 17.569 17.569 0 0 0 6.608 4.168c.601.211 1.286.033 1.77-.45l1.034-1.034a.678.678 0 0 0-.063-1.015l-2.307-1.794a.678.678 0 0 0-.58-.122l-2.19.547a1.745 1.745 0 0 1-1.657-.459L5.482 8.062a1.745 1.745 0 0 1-.46-1.657l.548-2.19a.678.678 0 0 0-.122-.58L3.654 1.328z"/></svg>
              <a href="tel:+1234567890">+1 (234) 567-890</a>
            </li>
            <li className="flex items-start gap-2" style={{ color: '#9ca3af', fontSize: '0.9rem' }}>
              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="#f97316" viewBox="0 0 16 16" style={{ marginTop: 3, flexShrink: 0 }}><path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10zm0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6z"/></svg>
              Dubai, UAE
            </li>
          </ul>
        </div>
